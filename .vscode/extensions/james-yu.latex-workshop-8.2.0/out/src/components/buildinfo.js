...
class BuildInfo {
    ...
    displayProgress(current) {
        ...
        const generateProgressBar = (proportion, length) => {
            ...
            const selectedCharacterSet = this.configuration.get('progress.barStyle');
        ...
        const runIconType = this.configuration.get('progress.runIconType');
        ...
        if (this.currentBuild.ruleProducesPages) {
            ...
            const barAsString = this.currentBuild.pageTotal
                ? generateProgressBar(current / this.currentBuild.pageTotal, this.configuration.get('progress.barLength'))
                : '';
