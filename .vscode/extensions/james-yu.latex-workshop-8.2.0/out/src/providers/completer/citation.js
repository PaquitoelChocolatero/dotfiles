...
class Citation {
    ...
    updateAll(bibFiles) {
        ...
        this.extension.manager.getIncludedTeX().forEach(cachedFile => {
            ...
            suggestions = suggestions.concat(cachedBibs.map(bib => {
                return Object.assign({}, bib, { key: bib.label, detail: bib.detail ? bib.detail : '', file: cachedFile, fields: {} });
            }));
        });
        return suggestions;
    }
    parseBibFile(file) {
        ...
        latex_utensils_1.bibtexParser.parse(fs.readFileSync(file).toString()).content
