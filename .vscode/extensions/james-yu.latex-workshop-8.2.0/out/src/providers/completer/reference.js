...
class Reference {
    ...
    updateAll(args) {
        ...
        this.extension.manager.getIncludedTeX().forEach(cachedFile => {
            ...
            cachedRefs.forEach(ref => {
                ...
                this.suggestions[ref.label] = Object.assign({}, ref, { file: cachedFile, position: ref.range.start, range: args ? args.document.getWordRangeAtPosition(args.position, /[-a-zA-Z0-9_:.]+/) : undefined });
    ...
    getRefFromNode(node, lines, nextNode) {
        ...
        else if (latex_utensils_1.latexParser.isTextString(node) && node.content === 'label=' && nextNode !== undefined) {
            // label={some=text}
